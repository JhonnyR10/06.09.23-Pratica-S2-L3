...
for (let i = 0; i < characters.length; i++) {
  for (let j = 0; j < femaleCharacters.length; j++) {
    if (characters[i] === femaleCharacters[j].name) characters.splice(i, 1);
  }
}
console.log(characters.length);
/* --EXTRA-- ESERCIZIO 10
...
console.log(
  ...
  starWarsCharacters[myRandom].name,
  "la sua altezza è: ",
  starWarsCharacters[myRandom].height,
  "la sua massa è: ",
  starWarsCharacters[myRandom].mass,
  "il colore dei suoi capelli è: ",
  starWarsCharacters[myRandom].hair_color,
  "il suo genere è: ",
  starWarsCharacters[myRandom].gender
);
